...
export default function EmpReport() {
    ...
    const [selectedFolder, setSelectedFolder] = useState("Offer Letter"); // State to track the selected folder
                        ...
                        <div className="progress-step">
                          <div className='progressbar-container'>
                            <div className={`progress-icon ${folderProgress[folder] === 100 ? "completed" : ""}`}
                              ...
                              {folderProgress[folder] === 100 ? <img src={require("assets/img/progress-tick-icon.png")} alt="..." className='progress-tick-icon' /> : "" }
                            </div>
